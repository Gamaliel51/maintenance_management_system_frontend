...
const StudentLogin = (props) => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post(`/api/auth/student/login`, {studentid: userName, password: password})
        .then((res) => {
    ...
    return(
        <div className="h-screen w-full flex flex-row justify-center items-center overflow-y-hidden  bg-[#eaecef]">
            <form onSubmit={handleSubmit} className='h-1/2 w-1/4 mx-24 mt-16 flex flex-col items-center justify-center shadow-2xl bg-white'>
                <div className='h-3/4 w-10/12 flex flex-col justify-evenly'>
                    <h1 className='h-fit w-full text-center font-semibold px-4'>Student Login</h1>
